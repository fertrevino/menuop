...
function generateImagePrompt(
  ...
  const basePrompt = description ? `${dishName}: ${description}` : dishName;
  ...
  return `Create a beautiful image of ${basePrompt}. Style: ${selectedStyle}. The image should be square format (1:1 aspect ratio), well-lit, and showcase the food in an appealing way suitable for a restaurant menu.`;
}
...
async function generateMultipleAIImages(
  ...
  const variations = [
    ...
    "artistic food styling, creative plating",
    "clean, minimalist food photography",
  ];
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.imageUrl) {
            ...
            return {
              url: data.imageUrl,
              alt: `AI-generated image of ${dishName} (${variantStyle})`,
              source: "ai-generated" as const,
              attribution: "Generated by AI",
