        ...
        <div className="relative bg-gradient-to-br from-gray-800/95 via-gray-900/95 to-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-md border border-gray-600/30 transform transition-all duration-300 scale-100 hover:scale-[1.02] z-10">
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#1F8349] to-[#2ea358] hover:from-[#176e3e] hover:to-[#248a47] text-white py-3 px-4 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-[#1F8349]/25 transform hover:-translate-y-0.5 relative overflow-hidden group cursor-pointer"
              >
            ...
            <div className="mt-6 space-y-3">
              <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-600/40 bg-gray-700/30 backdrop-blur-sm rounded-lg text-gray-300 hover:bg-gray-700/50 hover:border-gray-500/60 hover:text-white transition-all duration-200 group cursor-pointer">
                <svg
