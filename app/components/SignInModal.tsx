...
export default function SignInModal({ isOpen, onClose }: SignInModalProps) {
  ...
  // Listen for external events to open in forgot password mode
  useEffect(() => {
    const handler = (e: Event) => {
      const detail = (e as CustomEvent).detail as
        | { mode?: string; email?: string }
        | undefined;
      if (detail?.mode === "forgot-password") {
        // keep modal open if already open, else just set states
                ...
                return (
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 mb-6">
                      ...
                      <span className="text-[#1F8349] font-medium">
                        {email}
                      </span>
                    </p>
                    <p className="text-gray-400 text-sm mb-8">
                      Please check your email and click the confirmation link to
                      activate your account. You may need to check your spam
                      folder.
                    </p>
                    {error && (
              ...
              if (showResetEmailSent) {
                return (
                  <div className="text-center">
                    <div className="w-16 h-16 bg-[#1F8349]/20 rounded-full flex items-center justify-center mx-auto mb-6">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth="2"
                          d="M16 12a4 4 0 01-8 0m8 0a4 4 0 00-8 0m8 0h3m-11 0H5m6-9a9 9 0 110 18 9 9 0 010-18z"
                        />
                      </svg>
                    </div>
                    <h2 className="text-2xl font-bold text-white mb-4">
                    ...
                    <p className="text-gray-400 text-sm mb-8">
                      Check your email and follow the link to choose a new
                      password. The link will expire after a short time.
                    </p>
                    <div className="space-y-3">
                      <button
                        onClick={handleClose}
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-gradient-to-r from-[#1F8349] to-[#2ea358] hover:from-[#176e3e] hover:to-[#248a47] disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed text-white py-3 px-4 rounded-lg font-semibold transition-all duration-300"
                      >
