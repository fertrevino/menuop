...
export default function Settings() {
  ...
  const handleDeleteAccount = async () => {
    if (window.confirm("Are you sure you want to delete your account? This action cannot be undone and will permanently delete all your menus and data.")) {
      if (window.confirm("This is your final warning. Your account and all data will be permanently deleted. Are you absolutely sure?")) {
        try {
          ...
          alert("Account deletion feature will be implemented soon. Please contact support for account deletion requests.");
        } catch (error) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
                    ...
                    <div key={key} className="flex items-center justify-between py-3 border-b border-gray-700 last:border-b-0">
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">
                          {key === "emailUpdates" && "Receive important updates about your account"}
                          {key === "menuAnalytics" && "Get weekly reports about your menu performance"}
                          {key === "newFeatures" && "Be notified when new features are available"}
                          {key === "marketingEmails" && "Receive promotional offers and tips"}
                        </p>
                      </div>
            ...
            {activeTab === "menu-preferences" && (
              <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                <div className="flex justify-between items-center mb-6">
                  <h3 className="text-2xl font-bold text-white">Menu Preferences</h3>
                  <button
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setMenuPreferences({...menuPreferences, defaultCurrency: e.target.value})}
                      className="w-full bg-gray-700 text-white border border-gray-600 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#1F8349]"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setMenuPreferences({...menuPreferences, timeFormat: e.target.value})}
                      className="w-full bg-gray-700 text-white border border-gray-600 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#1F8349]"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setMenuPreferences({...menuPreferences, theme: e.target.value})}
                      className="w-full bg-gray-700 text-white border border-gray-600 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#1F8349]"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                  ...
                  <p className="text-gray-400 mb-6">
                    To change your password, you'll need to reset it using your email address.
                  </p>
                  <button
                    onClick={() => {
                      // TODO: Implement password reset
                      alert("Password reset feature will be implemented soon. Please contact support for password changes.");
                    }}
